...
private:
    ...
    void extractMetadataDirectives(const std::string& uri, const std::string& content, Scope* scope);
    ...
    SymbolPtr parseEnum(const std::string& line, int lineNum, const std::string& uri);
    
    // Stdlib conversion
    SymbolPtr stdFunctionToSymbol(const StdFunction& func, const std::string& modulePath);
    SymbolPtr stdClassToSymbol(const StdClass& cls, const std::string& modulePath);
    SymbolPtr stdEnumToSymbol(const StdEnum& enumDef, const std::string& modulePath);
